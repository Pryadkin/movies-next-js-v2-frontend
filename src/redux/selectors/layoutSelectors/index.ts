...
export const getIsAddPersonModalOpen = (state: RootState) => state.layoutReducer.isAddPersonModalOpen
...
export const getSelectPerson = (state: RootState) => state.layoutReducer.selectPerson
